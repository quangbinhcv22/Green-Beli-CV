...
{
    [CreateAssetMenu(fileName = nameof(BreedingHeroServerService), menuName = "ScriptableObject/Service/Server/BreedingHero")]
    public class BreedingHeroServerService : ScriptableObject, IDeserializeResponseMessage<TokenHasChangedResponse>, ITokenHasChangedService
    {
