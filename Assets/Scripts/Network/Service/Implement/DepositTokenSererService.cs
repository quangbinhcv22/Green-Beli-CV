...
{
    [CreateAssetMenu(fileName = nameof(DepositTokenSererService), menuName = "ScriptableObject/Service/Server/DepositToken")]
    public class DepositTokenSererService : ScriptableObject, IDeserializeResponseMessage<TokenHasChangedResponse>, ITokenHasChangedService
    {
