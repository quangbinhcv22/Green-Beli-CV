...
{
    [CreateAssetMenu(fileName = nameof(BreedingCancelServerService), menuName = "ScriptableObject/Service/Server/BreedingCancel")]
    public class BreedingCancelServerService : ScriptableObject, IDeserializeResponseMessage<TokenHasChangedResponse>, ITokenHasChangedService
    {
