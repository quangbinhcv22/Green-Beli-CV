...
{
    [CreateAssetMenu(fileName = nameof(WithDrawTokenSererService), menuName = "ScriptableObject/Service/Server/WithDrawToken")]
    public class WithDrawTokenSererService : ScriptableObject, IDeserializeResponseMessage<TokenHasChangedResponse>, ITokenHasChangedService
    {
