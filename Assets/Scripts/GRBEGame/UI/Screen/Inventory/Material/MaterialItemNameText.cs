...
{
    public class MaterialItemNameText : MonoBehaviour, IMemberView<MaterialInfo>
    {
        ...
        public void UpdateView(MaterialInfo data)
        {
            ...
            var nameItem = response.data.inventory.GetMaterialInventoryInfo(data.type).materialName;
