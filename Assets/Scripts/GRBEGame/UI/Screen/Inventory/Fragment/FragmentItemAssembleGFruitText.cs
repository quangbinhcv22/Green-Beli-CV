...
{
    public class FragmentItemAssembleGFruitText : MonoBehaviour, IMemberView<FragmentItemInfo>
    {
        ...
        public void UpdateView(FragmentItemInfo data)
        {
            ...
            text.SetText(string.Format(formatString,
                response.data.inventory.GetPriceToAssemble(data.type).gFruit.ToString("N0")));
        }
